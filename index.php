...
<?php
$tid=1;
$sql = "SELECT tbltestimonial.Testimonial,tblusers.FullName,tbltestimonial.Image from tbltestimonial join tblusers on tbltestimonial.UserEmail=tblusers.EmailId where tbltestimonial.status=:tid";
$query = $dbh -> prepare($sql);
...
{ 
  ?>
        ...
        <div class="testimonial-m">
          <div class="testimonial-img"> <img src="assets/images/<?php echo htmlentities($result->Image);?>" alt="" /> </div>
